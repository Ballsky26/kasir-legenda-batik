                    ...
                    <div class="card">
                        <div class="card-header align-items-center">
                            ...
                            <font size="1">
                                ...
                                Kota Pekalongan, Pekalongan Selatan, Kradenan Gg.01 <br>
                            </font>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <table id="total" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="" colspan="8">
                                                <form action="<?= base_url('manager/struk/print') ?>" target="_blank"
                                                    method="post">
                                                    <button class="btn btn-outline-success float-right">
                                                        <i class="fa fa-print"></i> Cetak Struk
                                                    </button>
                                                </form>
                                                <form action="<?= base_url('manager/transaksi') ?>" method="post">
