...
<!-- Modal Add Produk-->
<form action="<?= base_url('manager/produk/add'); ?>" method="post" enctype="multipart/form-data"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="nama_produk" placeholder="Produk" required>
                        <div class="invalid-feedback">
...
<?php
    $no = 1;
    foreach ($produk as $pdk) : $no++; ?>
<form action="<?= base_url('manager/produk/edit'); ?>" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="form-group col-sm-8">
                            <div class="row ml-1">
                                ...
                                <div class="col-sm-9 mb-5">
                                    <input type="number" class="form-control" name="harga" value="<?= $pdk['harga'];?>"
                                        required>
                                    <div class="invalid-feedback">
                                        Harga tidak boleh kosong!
                                    </div>
...
<?php
    $no = 1;
    foreach ($produk as $pdk) : $no++; ?>
<form action="<?= base_url('manager/produk/delete'); ?>" enctype="multipart/form-data" method="post">
