                ...
                <div class="container-fluid">
                    <div class="navbar-holder d-flex align-items-center justify-content-between">
                        ...
                        <div class="navbar-header">
                            <!-- Navbar Brand --><a href="<?= base_url('manager/dashboard') ?>" class="navbar-brand d-none d-sm-inline-block">
                    ...
                    <li><a rel="nofollow" href="#" class="dropdown-item all-notifications text-center"> <strong>view all notifications                                            </strong></a></li>
                            ...
                            <li class="nav-item">
                                ...
                                <div class="dropdown-menu dropdown-menu-right mr-4" aria-labelledby="userDropdown">
                                    <a class="dropdown-item" href="<?= base_url('manager/profile')?>">Pengaturan</a>
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="<?= ($this->uri->segment(2) == 'laporan') ? 'active' : ''; ?>">
                        ...
                        <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                            <li>
                                <a href="<?= base_url('manager/laporan/produk') ?>">
                                    <i class="fa fa-cubes"></i>Produk
                                </a>
                            </li>
                            <li>
                                <a href="<?= base_url('manager/laporan/penjualan') ?>">
